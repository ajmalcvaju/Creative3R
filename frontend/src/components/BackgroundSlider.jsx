...
const BackgroundSlider = () => {
      ...
      gsap.to(nextBgRef.current, {
        ...
        onComplete: () => {
          bgRef.current.style.backgroundImage =
            nextBgRef.current.style.backgroundImage;
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      <div ref={bgRef} className="absolute inset-0 bg-cover bg-center"></div>
      <div
        ref={nextBgRef}
      ...
      {/* Text Content */}
      <div className="absolute inset-0 flex flex-col items-start justify-center text-left text-white px-8 bg-gradient-to-r from-black via-black/70 to-transparent">
        <h1 className="text-4xl md:text-6xl font-bold mb-4 drop-shadow-lg">
          New Collection 2025
        </h1>
        <h2 className="text-2xl md:text-4xl mb-4 drop-shadow-lg">
          Discover Your Perfect Style
        </h2>
        <p className="text-lg md:text-2xl mb-8 drop-shadow-md max-w-2xl">
          Explore our curated collection of premium fashion items designed to
